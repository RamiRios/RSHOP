<?php
	...
	function registraUsuario($usuario, $pass_hash, $nombre, $ciudad, $direccion, $email, $activo, $token, $tipo_usuario){
		
		global $mysqli;
		
		$stmt = $mysqli->prepare("INSERT INTO usuarios (usuario, password, nombre, ciudad, direccion, correo, activacion, token, id_tipo) VALUES(?,?,?,?,?,?,?,?,?)");
		$stmt->bind_param('ssssssisi', $usuario, $pass_hash, $nombre, $ciudad, $direccion, $email, $activo, $token, $tipo_usuario);
